...
<body>
	<div id="top-nav-bar">
		<div class="tnb-right-section ">
			...
			<a href="../controlador/registre.php" class="user-anonymous tnb-signup-btn w3-bar-item w3-button w3-right ws-green ws-hover-green ga-top ga-top-signup">
				Sign Up
			</a>
			
			<a href="" class="user-anonymous tnb-login-btn w3-bar-item w3-btn bar-item-hover w3-right ws-light-green ga-top ga-top-login" >
			Log in
		</a>
		</div>
	</div>
